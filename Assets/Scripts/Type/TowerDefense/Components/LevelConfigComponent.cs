...
namespace Common
{
    ...
    public struct WaveConfigElement : IBufferElementData
    {
        ...
        public int Count;                       // 该类型僵尸数�?
        public float SpawnDelay;                // 该波开始后的生成延�?
    }
    ...
    public struct LevelPlantUnlockElement : IBufferElementData
    {
        ...
        public bool IsAvailable;                // 该关卡是否可�?
    }
}
