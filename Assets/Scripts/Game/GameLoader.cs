...
namespace Game
{
    ...
    public class GameLoader : MonoBehaviour
    {
        ...
        /// 关卡配置加载完成回调
        /// </summary>
        public event Action<LevelConfigComponent> OnLevelConfigLoaded;

        /// <summary>
        /// 游戏配置加载完成回调
        /// </summary>
        public event Action<GameConfigComponent> OnGameConfigLoaded;
        ...
        {
            UnityEngine.Debug.Log("=== GameLoader: StartLoad 被调�?===");
        ...
        private IEnumerator LoadSequence()
        {
            ...
            {
                UnityEngine.Debug.Log("GameLoader: 开始加载游戏配�?..");
            ...
            {
                UnityEngine.Debug.Log("GameLoader: 开始加载关卡配�?..");
            ...
            {
                var query = _entityManager.CreateEntityQuery(typeof(GameConfigComponent));
                if (query.TryGetSingleton<GameConfigComponent>(out var gameConfig))
                {
        ...
        private IEnumerator LoadGameConfig()
        {
            ...
            var loader = FindObjectOfType<GameConfigLoader>();
            if (loader == null)
            {
                var loaderObj = new GameObject("GameConfigLoader");
                loader = loaderObj.AddComponent<GameConfigLoader>();
            }

            loader.configJson = gameConfigJson;
            // GameConfigLoader会在Start时自动加�?
        ...
        private IEnumerator LoadLevelConfig()
        {
            ...
            if (loader == null)
            {
                ...
                loader = loaderObj.AddComponent<LevelConfigLoader>();
            }
        ...
        /// 获取当前加载的关卡配�?
        /// </summary>
        public bool TryGetLevelConfig(out LevelConfigComponent config)
        {
            config = default;
            ...
            var query = _entityManager.CreateEntityQuery(typeof(LevelConfigComponent));
            bool result = query.TryGetSingleton<LevelConfigComponent>(out config);
            query.Dispose();
            return result;
        }
        ...
        /// 获取当前游戏配置
        /// </summary>
        public bool TryGetGameConfig(out GameConfigComponent config)
        {
            config = default;
            if (_entityManager == null)
                return false;
            ...
            var query = _entityManager.CreateEntityQuery(typeof(GameConfigComponent));
            bool result = query.TryGetSingleton<GameConfigComponent>(out config);
            query.Dispose();
            return result;
        }
    }
