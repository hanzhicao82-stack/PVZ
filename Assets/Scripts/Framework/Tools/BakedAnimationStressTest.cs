...
namespace Framework
{
    ...
    public class BakedAnimationStressTest : MonoBehaviour
    {
        ...
        [Header("生成设置")]
        [Tooltip("生成数量（DrawMeshInstanced 单批次最夔1023个）")]
        [Range(1, 1023)]
        ...
        private void Initialize()
        {
            ...
            {
                UnityEngine.Debug.LogError("[BakedAnimationStressTest] BakeData �?Material 未设置！");
                return;
            }
            ...
            UnityEngine.Debug.Log($"[BakedAnimationStressTest] 初始�?{instanceCount} 个实�?x {meshCount} �?Mesh 用于 DrawMeshInstanced");
        }
