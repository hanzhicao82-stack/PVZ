...
namespace PVZ
{
    ...
    public class LevelConfigLoader : MonoBehaviour
    {
        ...
        public int levelToLoad = 1; // 默认加载第一�?
        ...
        private void UpdateGameStateFromLevel(EntityManager entityManager, LevelEntry level)
        {
            ...
            if (!query.IsEmpty)
            {
                ...
                UnityEngine.Debug.Log($"LevelConfigLoader: 已更新GameState - 时长={gameState.TotalGameTime}�?波次={gameState.TotalWaves}");
            }
            query.Dispose();
        }
        ...
        private static void LoadLevel1()
        {
            ...
            if (loader != null)
                ...
                UnityEngine.Debug.LogWarning("场景中没�?LevelConfigLoader");
        }
