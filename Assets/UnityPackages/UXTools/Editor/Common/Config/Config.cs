...
namespace ThunderFireUITool
{
    ...
    {
        public static readonly string RootPath = "Assets/UnityPackages/";

        public static readonly string SamplesRootPath = "Assets/UX_Samples/";

        public static readonly string AssetsRootPath = RootPath + "UXTools/Res/";
        public static readonly string ToolsRootPath = RootPath+ "UXTools/Editor/";
