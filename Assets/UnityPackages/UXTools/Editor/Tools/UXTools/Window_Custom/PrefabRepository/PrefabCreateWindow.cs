...
namespace ThunderFireUITool
{
    public class PrefabCreateWindow : EditorWindow
    {
        ...
        protected bool originalPack = true;
        ...
        protected virtual void InitWindowUI()
        {
            ...
            labelFromUXML.Q<VisualElement>("packPopupContainer").visible = false;
        ...
        private static bool CheckIsWidget(string path)
        {
            ...
            return list.Has(AssetDatabase.AssetPathToGUID(path));
        }
    }
}
#endif