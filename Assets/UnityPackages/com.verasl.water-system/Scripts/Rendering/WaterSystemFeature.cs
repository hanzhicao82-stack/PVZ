...
namespace WaterSystem
{
    public class WaterSystemFeature : ScriptableRendererFeature
    {
        ...
        {
            RendererCountMgr.AddCounter("Water");
            
            // WaterFX Pass
            m_WaterFxPass = new WaterFxPass {renderPassEvent = RenderPassEvent.BeforeRenderingOpaques};

            // Caustic Pass
            m_CausticsPass = new WaterCausticsPass(){renderPassEvent = RenderPassEvent.BeforeRenderingOpaques};
        ...
        {
            if (RendererCountMgr.GetCount("Water") > 0)
            {
