...
Shader "Legacy Shaders/Particles/Additive_AlphaBlended_Clip" 
{
    Properties 
    {
        ...
        [Enum(Addtive,1,AlphaBlend,10)] _DestBlend  ("Dest Blend Mode", Float) = 1
    }
        ...
        SubShader 
        {
            Pass 
            {
                ...
                UNITY_INSTANCING_BUFFER_START( Props )
                    ...
                    UNITY_DEFINE_INSTANCED_PROP( float, _UseClipRect)
                ...
                fixed4 frag (v2f i) : SV_Target
                {
                    ...
                    float c = UnityGet2DClipping(i.texcoord.zw, UNITY_ACCESS_INSTANCED_PROP(Props,_ClipRect));
                    col.a = lerp(col.a, c * col.a, UNITY_ACCESS_INSTANCED_PROP(Props,_UseClipRect));
