...
namespace UnityEditor.Recorder
{
    ...
    public class RecorderWindow : EditorWindow
    {
        ...
        void OnEnable()
        {
            ...
            CreateView();
            RegisterCallbacks();
            ((UniversalRenderPipelineAsset)QualitySettings.renderPipeline).upscalingFilter = UpscalingFilterSelection.Linear;
        }

        private void OnDisable()
        {
            ((UniversalRenderPipelineAsset)QualitySettings.renderPipeline).upscalingFilter = UpscalingFilterSelection.FSR;
        }
